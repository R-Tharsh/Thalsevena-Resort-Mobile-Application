...
public class event_booking extends AppCompatActivity {
    ...
    String[] Type = {"Wedding","Birthday", "Conference Meet", "Bachelor Party"};
    ...
    public int calculate() {
        ...
        if(type.getText().toString().equalsIgnoreCase("Wedding")){
        ...
        else if(type.getText().toString().equalsIgnoreCase("Conference Meet")){
            int cal = rcost3 * rnum;
            return cal;
        }
        else{
