...
public class Addinventory extends AppCompatActivity {
    ...
    Button log;
    //Spinner
    String[] InventoryType = {"Tables", "Beds","Chairs","Fan"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v3 = findViewById(R.id.inventory);
        ...
        awesomeValidation.addValidation(this,R.id.type, RegexTemplate.NOT_EMPTY,R.string.invalid_inventory_type);
        awesomeValidation.addValidation(this,R.id.inventory,".{1,2}",R.string.invalid_noof_inventory);
        awesomeValidation.addValidation(this,R.id.cost, Range.closed(1000,50000),R.string.invalid_inventory_cost);
        awesomeValidation.addValidation(this,R.id.fac, RegexTemplate.NOT_EMPTY,R.string.invalid_name);
